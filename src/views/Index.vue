<template>
  <div id="mallPage">
    ...
    <div id="main">
      ...
      <div class="m-news" v-for='(fyitem, index) in newsList' :key='index' v-show="(index+1) === currentPage">
        <van-row type="flex" justify="space-around" v-for='(item, index) in fyitem' :key='index'>
          <van-col span="4" v-for='nimg in item' :key='nimg.id'>
            <img :src="nimg.menuhref">
